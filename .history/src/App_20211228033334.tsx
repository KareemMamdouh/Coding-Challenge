...
function App() {
  ...
  const priorDate = new Date(today.getDate()-30).setDate(today.getDate()-30)
  useEffect(() => {
    fetch(`https://api.github.com/search/repositories?q=created:>${priorDate.toISOString().slice(0, 10);}&sort=stars&order=desc&page=${pageNumber}`)
